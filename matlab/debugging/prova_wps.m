...
num_axes         = 3;
waypoints=([3 8 10; 3 8 10; 3 8 10]);
            dim_nwps=size(waypoints)
            num_trajectories = dim_nwps(1,2); %number of waypoint
            State_start      = [Xo 0 0;... 
                                Yo 0 0;...
                                Zo 0 0];
            ...
            for i=1:num_trajectories
                Waypoints(:,:,i) = [    waypoints(1,i)  0.0  0.0  0.0  0.0; ...
                                        waypoints(2,i)  0.0  0.0  0.0  0.0; ...
                                        waypoints(3,i)  0.0 0.0 0.0 0.0];
            end
...
%     dist_wayps = [P_traj_x(j,1) P_traj_y(j,1)  P_traj_z(j,1)] - ... 
%                    [ waypoints(1,i) waypoints(2,i) waypoints(3,i) ];
%                   if norm(dist_wayps) < 0.5
%                    waypoints = waypoints(:,i+1:num_trajectories)
%                   end
